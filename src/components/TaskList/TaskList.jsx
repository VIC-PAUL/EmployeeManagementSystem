  ...
  return (
    ...
    >
      <div className="flex-shrink-0 h-full w-[300px] p-5 bg-red-400 rounded-xl">
        ...
        <h2 className="mt-5 text-2xl font-semibold">Make something</h2>
        <p className="text-sm mt-2">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Et eaque iste, exercitationem molestias architecto ut.</p>
      </div>
